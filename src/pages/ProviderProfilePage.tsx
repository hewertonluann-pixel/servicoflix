...
export const ProviderProfilePage = () => {
  ...
  return (
    <div className="min-h-screen pt-16 pb-6 lg:pb-20">
      {provider.isMock && (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 sm:-mt-24 lg:-mt-32 relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          <div className="w-full lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            {/* Card do perfil (avatar + nome + info) */}
            ...
            {/* ── BARRA DE PREÇO + AÇÕES — apenas mobile, inline no fluxo ── */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.05 }}
              className="lg:hidden bg-surface border border-border rounded-xl p-3 flex items-center gap-3"
            >
              {/* Preço */}
